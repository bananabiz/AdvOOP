...
@date: 19/03/2018
@author: Yongli Wang
@brief: Script to control the Player movement
===============================================*/
    ...
    public class PlayerController1 : MonoBehaviour
    {
        ...
        bool CheckGround(RaycastHit2D hit)
        {
            ...
            if (hit.collider != null &&  //It hit something AND
                ...
                !hit.collider.isTrigger)  //It didn't hit a trigger
            {
        ...
        void DetectGround()
        {
            ...
            Ray groundRay = new Ray(transform.position, Vector3.down);
            // Set Hit to 2D Raycast (ray might hit other players or objects)
            ...
            foreach (var hit in hits)
            {
                if (CheckGround(hit))
                {
                    ...
                    break; //break == exit this loop and continue below; 
                           //continue == skip this loop below and jump to next loop below
                           //return == exit the loop and go back to top
                }
